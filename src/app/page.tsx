        ...
        <div className="space-y-12 w-full py-12">
              ...
              <BlurFade delay={BLUR_FADE_DELAY * 11}>
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Here are some certifications I have earned, demonstrating my skills and expertise.
                    </p>
                  </div>
                </div>
              </BlurFade>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-[800px] mx-auto">
              {DATA.certificates.map((cert, id) => (
                <BlurFade key={cert.title} delay={BLUR_FADE_DELAY * 12 + id * 0.05}>
                  <CertificateCard
                    title={cert.title}
                    issuer={cert.issuer}
                    date={cert.date}
...
<section id="contact">
  <div className="grid items-center justify-center gap-5 px-4 text-center md:px-6 w-full py-14">
